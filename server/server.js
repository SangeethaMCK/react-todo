import pkg from "pg";
const { Client } = pkg;
import { server } from "../../../http1.0/server/server.js";
import { cors } from "../../../http1.0/server/cors.js";
import {bodyParser} from "../../../http1.0/server/bodyParser.js";
import {
  getTodos,
  postTodos,
  deleteTodos,
...
app.route("GET", "/todos", getTodos);
app.route("POST", "/todos", postTodos);
app.route("DELETE", "/todos", deleteTodos);
app.route("DELETE", "/todos/:id", deleteTodosById);
app.route("PUT", "/todos/:id", putTodosById);
app.route("PATCH", "/todos/:id", patchTodosById);
